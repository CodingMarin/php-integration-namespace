<?php
use controllers\controllerLOG;
include '../controllers/controllerLOG.php';
...
if(isset($_POST['login']))
{
    ...
    $controller->login($txtusername,$txtpassword);
} else {
    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="POST" action="">
          ...
          <input class="form__input" type="text" placeholder="Email" name="username">
          <input class="form__input" type="password" placeholder="Password" name="password">
          <button class="switch__button button switch-btn" href="" name="login">LOGIN</button>
        </form>
      </div>
      <div class="switch">
        ...
        <div class="switch__container">
          ...
          <button class="switch__button button" href="">SIGN IN</button>
        </div>
      </div>
    </div>
